...
## 5. 다음 단계 — D-7 billing 또는 별 트랙

D-9 완료 후 진입 후보:
1. **D-7 billing** (0.3세션, 매우 가벼움, (나) v2.0 대기 권장)
2. **별 트랙 #A PITR** (5/7 슬롯, 결재 #1 후, 0.2세션)
3. **D-8 dashboard 종합** (1.3세션, 함수 재활용 + B-2 묶음)
4. **D-final 보안 sweep** (1.0세션, D-9 RBAC 회귀 포함)
