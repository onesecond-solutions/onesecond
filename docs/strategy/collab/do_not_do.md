...
> 🗑️ **대체됨 / 이력 보존용 (2026-05-31 표기).**
> 본 문서는 2026-05-10 시점 회귀 신호 스냅샷이다. **현행 회귀 신호 진실 원천 = `docs/strategy/master_strategy_v1.md` §14.** START PROTOCOL 6단계 점검 경로에 본 문서는 포함되지 않는다. 회귀 신호는 master_strategy_v1 §14를 기준으로 본다.
