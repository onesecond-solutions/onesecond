...
- `docs/sessions/2026-07-23_1739.md` — 2026-07-23 오후 (PR #1385~#1393 9건 라이브: V3 de-iframe 후속[거터24·분기점1120·읽는폭710 유지 확정] / 홈 보장분석 축 카드 6개+빈 페이지[의료실비·암·뇌 심장·수술비·간병·기타, 임태성 게이트] / 고객관리 서버필터+200행 페이지네이션+데이터현황 집계 분리[1000행 절단 해소] / 지식 카테고리 스펙 v2 대조저장 + 레지스트리 설계안 + 원장 생성 PR-A[화면 무변화])
- `docs/sessions/2026-07-16_1911.md` — 2026-07-16 저녁 (보장분석 앱 정식 통합 라이브: PR #1303·main `35db5ff`·GitHub Pages 배포·onesecond.solutions 실측 정합. 신규 `js/bojang.js` +681 = `#v-bojang` 발송센터 허브 + 6서브화면 미니라우터, 의료실비 서브=cov-medical.js 세대판정 흡수[DB write 0], 맞춤결과=sanitized 샘플, CSS `#v-bojang` 스코프 격리, cov-medical→bojang 리다이렉트. 대표 B[앱 통합] 승인→빌더 위임→총괄 검수·머지·라이브 검수 종결. 다음=다크 테마 육안[대표 세션]·Phase2[자동생성·공개URL·PDF·이미지])
- `docs/sessions/2026-07-10_1340.md` — 2026-07-10 오후 (팀/지점 공유 업무노트 수정·삭제 완결: #1214 수정폼 DOM버그·#1216 매니저 RLS[CI채널 실반영]·#1217 프론트 버튼 + #1213 상담관리 유형 임태성 게이트 + ★DB/EF 실행 원칙 START PROTOCOL 박제[39fc972])
- `docs/sessions/2026-07-05_0614.md` — 2026-07-05 오전 (랜딩→홈 전환 로그아웃 사고·긴급복구 #1086 + 로딩 절반 감량 #1087·#1088 + 기획팀장 검색데이터 246건 상품라인업 연결 #1089 + 라이브러리 핀고정 #1090)
