...
| # | 트랙 | 본질 | 시급도 |
|---|---|---|---|
| **#30** | 🚨 Custom SMTP 도입 (5/15 전 필수, P1.5-E rate limit 사고로 입증) | 4팀 약 40~50명 동시 가입 시 인증 메일 차단 차단 | **🔴 Critical** |
...
| **#37** | 인증 메일 한국어 템플릿 (#31 묶음, D8 결재 (b)) | 4팀 약 40~50명 한국어 사용자 | 🟢 5/12~14 |
