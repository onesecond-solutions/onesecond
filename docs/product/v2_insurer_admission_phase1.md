...
```
[admin]                실장님 공지 / 스마트 게시판 / 네비게이션방 / 보험사게시판 (4탭)
[사용자 (ga_*)]         실장님 공지 / 스마트 게시판 / 네비게이션방 (3탭)
...
| role | 실장님 공지 | 매니저라운지 | 네비방 | 스마트 게시판 | 보험사 | 허브 | 회원가입 폼 |
|---|---|---|---|---|---|---|---|
...
| 9 | 일방향 자동 저장 + 시드 자동 분기 + 통합 view 1차 준비 | 1.3 | 답변 가시성 자동 + admin 토글 #2 골격 |
...
| 5/12 (월) | Step 8 마무리 + Step 9 진입 | 6필드+검색창 + 일방향 자동 저장 |
| 5/13 (화) | Step 9 마무리 + Step 10~12 (admin 융합) | 일방향 자동 저장 + admin D-1/D-9/D-10 |
