...
│                                                       │
│  👀 시력 본진 (선택, just funny + 헛웃음 + 딸깍)      │
│   "혹시 시력 교정·백내장·노안 수술 하셨습니까? 😎"   │
│   ○ 딸깍! ✨ 잘 보여요                               │
│   ○ 아직요... 😅 (헛웃음)                            │
│   ○ 음... 비밀 🤫                                     │
│                                                       │
...
| 시력 본진 (퍼니) | 교정 박힘 / 아직 / 비밀 | **자동 추천 본진 정밀화** (50~60대·70대+ 박힌 자리 박힐 자리) |
| 성별 | 남성 / 여성 / 선택 박지 X | (UI 본진 박지 X, 자동 추천 자리만) |

### 3-1-b. 시력 본진 퍼니한 질문 (팀장님 본인 명시 박힘)

> "추천은 하지만 요즘은 백내장 노안 수술 한 사람도 많기 때문에 퍼니한 요소로 질문 한 번 해줘, 혹시 시력 교정, 백내장, 노안 수술을 하셨습니까? 이런 퍼니한 요소 첨부"

본 자리 본진 = **친근한 톤 + 농담 본진** 박힘:
- 옛 격차: 연령만 박힌 자리 = 50대+ 박힌 자리 = 자동 큰 글씨 = 본인 박힌 자리 실제 시력 박지 X 박혀 불일치 격차
- 본진: 시력 교정 본진 박힌 자리 본인 박힐 자리 = 본인 실제 시력 정합 박힘 자리

### 톤 본진 — just funny + 헛웃음 + 딸깍 (팀장님 본인 명시 박힘)

> "just funny, 헛웃음, 딸깍 이런 요소를 활용하고 싶은거야"

옵션 본진 (가벼운 톤 정합):
- ✨ **"딸깍! 잘 보여요"** = 시력 교정/백내장/노안 수술 박힘 → 딸깍 본진 정합(시술 = 딸깍 = 1초 안 박힘) → 자동 큰 글씨 박지 X (보통 폰트 박힘)
- 😅 **"아직요... (헛웃음)"** = 안경/돋보기 박힘 자리 → 연령 본진 따라 박힘. 헛웃음 톤 박힘
- 🤫 **"음... 비밀"** = 본인 박지 X → 연령 본진 따라 박힘 (기본값). 친근 톤 박힘

### 본진 정체성 정합

- **딸깍 본진** ✅ = "딸깍! 잘 보여요" 박힌 자리 본인 박힐 자리 (§15 정체성 본진 정합) — 시술 = 딸깍 = 1초 안 박힘 메타 박힘
- **헛웃음 본진** ✅ = "아직요... 😅" 박힌 자리 본인 박힐 자리 (사용자 본인 박힐 자리 친근 정합)
- **just funny 본진** ✅ = 옵션 텍스트 통째 가벼운 톤 박힘 (진지 박지 X)
...
### 3-3. 자동 추천 본진 (연령 × 시력 매트릭스)

| 연령 | 시력 교정 박힘 (✨) | 시력 교정 박지 X (👓) | 비밀 (🤫) |
|---|---|---|---|
| 20대 | 폰트 13~15px / 다크 OK | 폰트 15px / 라이트 | 폰트 15px (기본) |
| 30~40대 | 기본값 통째 | 기본값 통째 | 기본값 통째 |
| 50~60대 | 폰트 15px (보통, "잘 보인다 했으니까!" 😎) | 폰트 17px / 브라운 기본 | 폰트 17px (안전) |
| 70대+ | 폰트 17px (안전, "안경 박힘 자리 정합") | 폰트 20px / 고대비 / 다크 박지 X | 폰트 20px (특대) |

본 자리 = 본인 명시 박힌 자리 본진 박지 X 박힌 자리 박힘 (옵트인 본진 정합).

### 3-3-b. 퍼니한 본진 정합 박힘

50~60대 + 시력 교정 박힌 자리 박힐 자리 = 자동 17px 박지 X 박힘 (15px 박힘) — **본인 박힌 자리 본진 정합 박힘** (실제 시력 박힘 자리 본인 박힐 자리).

본 자리 본진 = 사용자 본인 박힐 자리 본진 본인 박힐 자리 친근한 정합 박힐 자리 ("아 본인 박은 자리 본진 박힘!" 박힐 자리).
...
CREATE TABLE public.user_preferences (
  ...
  vision_corrected  text CHECK (vision_corrected IN ('yes','no','secret')),  -- 퍼니 본진: 시력 교정·백내장·노안 수술
