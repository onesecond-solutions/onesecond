-- ════════════════════════════════════════════════════════════════════
-- 2026-05-24 contact_info 단독 SQL (묶음 2 분할 자체 — C안 자체)
-- ════════════════════════════════════════════════════════════════════
-- 격차 본질:
--   직전 묶음 2 SQL (PR #45, 492줄) = 자체 가동 X 본질 격차
--   분할 자체 = insurance_age 단독 + contact_info 단독 (각각 별 PR)
--
-- 본 SQL 자체:
--   contact_info (보험회사 연락처) 단독 — 분홍 strip #F472B6
--   + <style> 블록 통째 제거
--   + 미박힘 row 7건 = "정보 준비 중" 자체 안내
--
-- insurance_age 자체 자체 = 별 PR 자체 (PR #47)
--   파일 자체: 2026-05-24_quick_overlay_insurance_age_only.sql
--
