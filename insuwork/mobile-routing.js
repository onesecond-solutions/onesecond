...
(function () {
  ...
  var extraSections = ['ledger', 'briefing', 'daily-briefing', 'newsletters', 'sales-strategy', 'notice-updates', 'user-guide', 'feedback', 'carriers', 'payments', 'scripts', 'insurance-age', 'tools', 'trash', 'archive', 'public-library', 'admin-users'];
  function isPhone() {
