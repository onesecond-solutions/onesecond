...
(function () {
  ...
  var extraSections = ['insurance-portal', 'ledger', 'briefing', 'daily-briefing', 'newsletters', 'product-lineups', 'sales-strategy', 'notice-updates', 'user-guide', 'feedback', 'carriers', 'payments', 'scripts', 'insurance-age', 'tools', 'trash', 'archive', 'public-library', 'admin-users', 'personal-office', 'my-work'];
  function isPhone() {
