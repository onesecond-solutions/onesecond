...
(function () {
  'use strict';
  var titles = { ledger: '가계부', 'daily-briefing': '뉴스 브리핑', briefing: '보험브리핑', newsletters: '참고자료', 'sales-strategy': '영업자료', 'notice-updates': '공지·업데이트', 'user-guide': '사용자 가이드', feedback: '의견 보내기' };
