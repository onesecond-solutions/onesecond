...
(function () {
  ...
  function header(title, activeKey, opts) {
    ...
    return '<header class="iwm-header">'
      ...
      + '<a class="iwm-menu-item" href="/insuwork/?view=insuwork&section=notice-updates" role="menuitem">공지·업데이트</a>'
      + '<a class="iwm-menu-item" href="/insuwork/?view=insuwork&section=user-guide" role="menuitem">사용자 가이드</a>'
      + '<a class="iwm-menu-item" href="/insuwork/?view=insuwork&section=feedback" role="menuitem">의견 보내기</a>'
      + '</div>'
      + '</div>'
