...
(function () {
  ...
  function header(title, activeKey, opts) {
    ...
    return '<header class="iwm-header">'
      ...
      + (window._canSeeInsuworkLedger && window._canSeeInsuworkLedger() ? '<a class="iwm-menu-item" href="./section.html?view=insuwork&section=insurance-portal" role="menuitem">보험포털</a>' : '')
