(function () {
  ...
  function renderAccount() {
    ...
    var adminMenu = String(email || '').toLowerCase() === 'bylts@naver.com' ? '<div class="iw-account-group"><button type="button" id="iw-office-open" role="menuitem">개인 오피스</button></div>' : '';
    ...
    var adminUsersBtn = document.getElementById('iw-office-open'); if (adminUsersBtn) adminUsersBtn.addEventListener('click', function () { closeAccountMenu(); if (window.OSInsuwork && window.OSInsuwork.go) window.OSInsuwork.go('personal-office'); });
