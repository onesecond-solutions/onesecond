(function () {
  ...
  function loadData(force) {
    ...
    var requests = full ? [
      api('workspace_items?owner_id=eq.' + id + '&deleted_at=is.null&or=(visibility.eq.private,legacy_source.is.null)&order=created_at.desc&limit=2000&select=*'),
      ...
      api('workspace_items?owner_id=eq.' + id + '&deleted_at=is.null&or=(visibility.eq.private,legacy_source.is.null)&order=created_at.desc&limit=6&select=*'),
