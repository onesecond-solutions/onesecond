(function () {
  ...
  function consultationTextForCustomer(customer, latestConsult) {
    var profile = customerProfile(customer);
    var consultText = latestConsult ? stripHtml(latestConsult.memo || latestConsult.content || '') : '';
