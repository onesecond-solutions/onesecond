(function () {
  ...
  function resizeNameColumn(customerId, rowId, textarea) {
    ...
    if (section) section.style.setProperty('--iw-ca-name-w', textColumnWidth(draft(customerId).rows, 'name', '담보', 150, 360) + 'px');
  }
