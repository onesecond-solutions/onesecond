...
(function () {
  ...
  function injectStyleOnce() {
    ...
    st.id = 'bj-style';
    st.textContent = [
      '#v-bojang{--bj-ground:#0A0F1F;--bj-ground2:#0E1428;--bj-panel:#141B31;--bj-panel2:#111830;--bj-ink:#F5F2E9;--bj-muted:#9AA3BC;--bj-faint:#6E7794;--bj-gold:#D9B268;--bj-gold-b:#F1D096;--bj-line:rgba(233,214,170,.14);--bj-good:#57C295;--bj-warn:#E6B65B;--bj-weak:#E8917A;--bj-r:20px;padding:0;overflow-y:auto;min-height:100%;background:radial-gradient(120% 55% at 50% -6%,rgba(217,178,104,.13),transparent 58%),linear-gradient(180deg,var(--bj-ground),var(--bj-ground2));color:var(--bj-ink);font-family:\'Pretendard\',\'Apple SD Gothic Neo\',\'Malgun Gothic\',\'맑은 고딕\',\'Noto Sans KR\',system-ui,sans-serif;-webkit-font-smoothing:antialiased;letter-spacing:-.2px;}',
      ...
      '#v-bojang .bj-back{background:rgba(255,255,255,.04);border:1px solid var(--bj-line);color:var(--bj-ink);font-size:13px;font-weight:700;padding:8px 15px;border-radius:11px;cursor:pointer;font-family:inherit;}',
      ...
      '#v-bojang .bj-row{display:flex;align-items:center;gap:13px;background:linear-gradient(160deg,var(--bj-panel),var(--bj-panel2));border:1px solid var(--bj-line);border-radius:18px;padding:14px 15px;cursor:pointer;transition:.16s;}',
      ...
      '#v-bojang .bj-ab{display:grid;place-items:center;width:38px;height:38px;border-radius:11px;cursor:pointer;border:1px solid var(--bj-line);background:rgba(255,255,255,.03);color:var(--bj-ink);font-size:18px;font-weight:800;line-height:1;}',
      ...
      '#v-bojang .bj-note{margin-top:16px;background:rgba(217,178,104,.07);border:1px solid rgba(217,178,104,.22);border-radius:14px;padding:14px 16px;font-size:12.5px;line-height:1.7;color:#C9CFDF;}',
      ...
      '#v-bojang .bj-toast{position:fixed;left:50%;bottom:26px;transform:translateX(-50%) translateY(20px);background:var(--bj-gold-b);color:#241B08;font-size:13.5px;font-weight:800;padding:12px 20px;border-radius:12px;opacity:0;pointer-events:none;transition:.3s;box-shadow:0 10px 30px rgba(0,0,0,.4);z-index:50;}',
      ...
      '#v-bojang .bj-item{background:linear-gradient(160deg,var(--bj-panel),var(--bj-panel2));border:1px solid var(--bj-line);border-radius:var(--bj-r);overflow:hidden;}',
      ...
      '#v-bojang .bj-accrow{padding:11px 0;border-top:1px solid rgba(255,255,255,.06);}',
      ...
      '#v-bojang .bj-v{font-size:13.5px;line-height:1.65;color:#C9CFDF;}',
      '#v-bojang .bj-v b,#v-bojang .bj-bd b{color:var(--bj-gold-b);font-weight:800;}',
      /* quiz(share) */
      '#v-bojang .bj-quiz{background:linear-gradient(160deg,var(--bj-panel),var(--bj-panel2));border:1px solid var(--bj-line);border-radius:var(--bj-r);padding:20px 18px;}',
      '#v-bojang .bj-q{margin-bottom:16px;}',
      '#v-bojang .bj-q:last-of-type{margin-bottom:0;}',
      '#v-bojang .bj-qt{font-size:14.5px;font-weight:700;line-height:1.5;margin-bottom:10px;color:#E7EAF3;}',
      '#v-bojang .bj-qt b{color:var(--bj-gold-b);font-weight:800;}',
      '#v-bojang .bj-opts{display:flex;gap:9px;}',
      '#v-bojang .bj-opt{flex:1;padding:12px 6px;border-radius:12px;border:1px solid var(--bj-line);background:rgba(255,255,255,.02);color:var(--bj-muted);font-size:13.5px;font-weight:700;cursor:pointer;font-family:inherit;transition:.18s;}',
      ...
      '#v-bojang .bj-rd{font-size:13px;color:#C9CFDF;line-height:1.65;}',
      /* blocks(type) */
      '#v-bojang .bj-blocks{display:flex;flex-direction:column;gap:12px;margin-top:24px;}',
      '#v-bojang .bj-b{background:linear-gradient(160deg,var(--bj-panel),var(--bj-panel2));border:1px solid var(--bj-line);border-radius:var(--bj-r);padding:19px 18px;}',
      '#v-bojang .bj-bt{font-size:16.5px;font-weight:800;line-height:1.45;margin-bottom:7px;}',
      '#v-bojang .bj-bd{font-size:13.5px;line-height:1.72;color:#C4CBDD;}',
      '#v-bojang .bj-gens{display:flex;gap:7px;margin-top:14px;flex-wrap:wrap;}',
      '#v-bojang .bj-gen{flex:1;min-width:78px;text-align:center;padding:10px 6px;border-radius:11px;background:rgba(255,255,255,.02);border:1px solid var(--bj-line);}',
      ...
      '#v-bojang .bj-lo{flex:1;text-align:center;padding:9px 6px;border-radius:10px;background:rgba(255,255,255,.02);border:1px solid var(--bj-line);color:var(--bj-muted);font-weight:700;}',
      ...
      '#v-bojang .bj-check{margin-top:24px;background:linear-gradient(160deg,var(--bj-panel),var(--bj-panel2));border:1px solid var(--bj-line);border-radius:var(--bj-r);padding:20px 18px;text-align:center;}',
      ...
      '#v-bojang .bj-table td{padding:10px;border-bottom:1px solid rgba(255,255,255,.06);vertical-align:top;color:#C4CBDD;}',
      ...
      '#v-bojang .bj-tdone{color:#C4CBDD;line-height:1.5;}',
      ...
      '#v-bojang .bj-date{font-size:15px;padding:10px 12px;border:1px solid var(--bj-line);border-radius:11px;background:rgba(255,255,255,.04);color:var(--bj-ink);color-scheme:dark;}',
      ...
      '#v-bojang .bj-medone{font-size:14.5px;line-height:1.6;margin:0 0 10px;color:#E7EAF3;}',
      ...
      /* cta */
      '#v-bojang .bj-cta{margin-top:26px;background:linear-gradient(155deg,#1B2340,#141A30);border:1px solid rgba(217,178,104,.3);border-radius:var(--bj-r);padding:24px 20px;text-align:center;position:relative;overflow:hidden;}',
      ...
      '#v-bojang .bj-sign{display:inline-flex;align-items:center;gap:10px;padding:12px 18px;border-radius:14px;background:rgba(255,255,255,.03);border:1px solid var(--bj-line);}',
      ...
      '#v-bojang .bj-ax{display:flex;align-items:flex-start;gap:13px;background:linear-gradient(160deg,var(--bj-panel),var(--bj-panel2));border:1px solid var(--bj-line);border-radius:16px;padding:15px;border-left-width:3px;}',
      ...
      '#v-bojang .bj-axtag{font-size:10.5px;font-weight:800;margin-left:6px;padding:2px 8px;border-radius:99px;background:rgba(255,255,255,.05);border:1px solid var(--bj-line);color:var(--bj-muted);vertical-align:middle;}',
      ...
      '#v-bojang .bj-ptlist li{font-size:13.5px;line-height:1.7;color:#C4CBDD;margin-bottom:6px;}',
